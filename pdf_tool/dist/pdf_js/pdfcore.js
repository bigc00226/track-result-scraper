...
(function (root, factory) {
    ...
    var HEADER_WORD = /^(ﾚｰﾝ|レーン|ORD|試|順|試順|ﾅﾝﾊﾞｰ|ナンバー|ﾚｰﾝﾅﾝﾊﾞｰ|氏|名|氏名|所|属|所属|資格|記録|資格記録|前記録|参考記録|順位|ｺﾒﾝﾄ|コメント|通過|得点|ﾁｰﾑ|ｵｰﾀﾞｰ|ｶﾅ|3回|3回まで|4回以降|の最高|の試技順|ﾍﾞｽﾄ|ﾄｯﾌﾟ8|総合|[1-6]回目|風|.*\/(資格|参考)記録|順位\(ﾅﾝﾊﾞｰ\)記録|\(順位\)記録)$/;
